...
<html>
<script type="text/javascript" language="javascript" src="${ctx}/js/countdownFindPassword.js"></script>
<body>
<div class="register-container animated fadeInDown">
 <div class="registerbox bg-white">
    ...
    <div class="registerbox-textbox email-span">
      <p class="gray-dark font-130" id= "access">密码重置邮件已经发送到邮箱</p>
          <font color="red" size="-1" id="deny"></font>
      <p class="orange">${user.email}</p>
      <p class="gray-dark">请24小时内进入邮件中的链接继续操作</p> 
